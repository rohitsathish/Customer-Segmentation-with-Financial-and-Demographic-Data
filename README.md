...
This project is based on the 'Creating Customer Segments with Arvato' project of the Introduction to Machine Learning with PyTorch nanodegree on Udacity. Due to the sensitive nature of the data used for the project, the data cannot be uploaded here based on the terms agreed and hence the results are non-reproducible.
